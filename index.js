...
const ApolloApp = () => {
	...
	return (<SafeAreaProvider>
		<AppearanceProvider>
			<ApplicationProvider {...eva} theme={darkMode && {...eva.dark, "background-basic-color-1": "#121212"} || eva.light} >
						...
						theme={darkMode && 
							{
								...
								dark: true,
								borderWidth: 0.2,
								colors: { ...PaperDarkTheme.colors, primary: '#121212', secondary: '#F5F5F5', header: '#424242', divider: '#616161', lightBackground: '#212121' }
							} ||
							{
								...PaperDefaultTheme,
								borderWidth: 0.2,
								colors: { ...PaperDefaultTheme.colors, primary: '#fcfcfc', secondary: '#212121', header: '#EEEEEE', divider: '#EEEEEE', lightBackground: '#F5F5F5' },
							}
						}
					>
